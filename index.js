...
let up = `🚀 *_SHEHAN MD Connected Successfully!_* ✅ 

--- *🧚‍♀️🎉 _Welcome to SHEHAN!_* 🎉🧚‍♀️ 
...
*ꜱʜᴇʜᴀɴ-ᴍᴅ ᴄʀᴇᴀᴛᴇᴅ ʙʏ ꜱʜᴇʜᴀɴ ʙᴏʏッ*`;
...
if(senderNumber.includes("94784249254")){
if(isReact) return
m.react("👨‍💻")
}       
 
if(senderNumber.includes("94774395354")){
if(isReact) return
m.react("💗")
}
//=====Auto-Read-Cmd==========
...
app.get("/", (req, res) => {
res.send("hey,ShehaN-MD bot started✅");
});
